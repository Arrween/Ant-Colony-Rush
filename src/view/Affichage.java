...
// public static final Dimension PANELSIZE = new Dimension((int)
// (Terrain.LARGEUR * RATIO_X),
...
// // afficher le fond
// g.drawImage(Terrain.BACKGROUND, 0, 0, (int) PANELSIZE.getWidth(), (int)
// PANELSIZE.getHeight(), this);
...
// g.drawImage(img, obj.getX() - ObjetFixe.HALF_SIZE, obj.getY() -
// ObjetFixe.HALF_SIZE,
