...
public class TerrainPanel extends JPanel {
    ...
    // Getter optionnel : on considère que le mode nuit est activé quand targetAlpha atteint DESIRED_ALPHA
        ...
        for (ObjetFixe obj : Terrain.getObjetsFixes()) {
            ...
            if (img != null) {
                ...
                if (obj instanceof RessourceTemporaire) {
                    RessourceTemporaire resTemp = (RessourceTemporaire) obj;
                    String str = (resTemp.getTempsRestant() / 1000) + "s";
