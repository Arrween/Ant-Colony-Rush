// Classe à refaire complétement pour l'animation du crapaud
...
// ImageIO.read(getClass().getResource("/ressources/Frog/Idle.png"));
...
// ImageIO.read(getClass().getResource("/ressources/Frog/Jump.png"));
// columns = 4;
// rows = 1;
...
// // État LAND
// BufferedImage landSheet =
// ImageIO.read(getClass().getResource("/ressources/Frog/Land.png"));
// columns = 4;
// rows = 1;
...
// // État TURN
// BufferedImage turnSheet =
// ImageIO.read(getClass().getResource("/ressources/Frog/Turn.png"));
// columns = 4;
// rows = 1;
...
// // Ici vous pouvez ajouter une logique pour changer d'état selon le
// comportement
// // du crapaud.
// // Par exemple, si le crapaud vient de changer de direction, vous pouvez
// passer
