...
public class TestCrapaud {
    public static void main(String[] args) {
        ...
        // Vous pouvez par exemple utiliser un JLayeredPane pour superposer les affichages
        ...
        // Boucle de jeu avec un Timer pour mettre à jour le crapaud et rafraîchir l'affichage
